...
md"# C Compilation Benchmarks for JuliaCON 2025"
...
sort(unique(c_results[!, :code]))

# ╔═╡ 20e013eb-5bd8-4d6a-a0b0-241982ee27b9
...
begin
	...
	for (k, subdf) in pairs(sample_gdf)
...
Create a plot based on 3 types of parameters:
...
manifest_format = "2.0"
project_hash = "4932cc2678a0621e82f6dfd3dff7f6bfe8db63b0"
